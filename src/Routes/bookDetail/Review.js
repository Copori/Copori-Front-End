        ...
        <div className="BookDetail__Reivew__contents__box">
          ...
          {toggle ? (
            <div className="BookDetail__Reivew__contents__box--star" ref={starPick}>
              <label onClick={onStar1Click} htmlFor="1">
                <BsFillStarFill />
              </label>
              <input type="radio" name="pos" id="1" value="1" />
              <label onClick={onStar2Click} htmlFor="2">
                <BsFillStarFill />
              </label>
              <input type="radio" name="pos" id="2" value="2" />
              <label onClick={onStar3Click} htmlFor="3">
                <BsFillStarFill />
              </label>
              <input type="radio" name="pos" id="3" value="3" />
              <label onClick={onStar4Click} htmlFor="4">
                <BsFillStarFill />
              </label>
              <input type="radio" name="pos" id="4" value="4" />
              <label onClick={onStar5Click} htmlFor="5">
                <BsFillStarFill />
              </label>
          ...
          {toggle ? (
            <div className="BookDetail__Reivew__contents__box--text">
              <span>
                <input onChange={onChange} type="text" placeholder="리뷰를 입력하세요" />
              </span>
            </div>
          ) : (
            <div className="BookDetail__Reivew__contents__box--text">
